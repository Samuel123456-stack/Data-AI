...
# __fastapi_example.py__: Exemplo básico de *API FastAPI*, com endpoints simples para teste de funcionamento e deploy local via *Uvicorn (servidor web)*.

# __fastapi_example_2.py__: API FastAPI que simula uma *conta bancária*, permitindo:

# - Consulta de saldo.
# - Realização de saques
# - Controle básico de clientes em memória

# __fastapi_example_3.py__: API que disponibiliza um *agente RAG como serviço*, permitindo perguntas sobre um *PDF Remoto*, utilizando:
